<div id="wsb-canvas-template-page" class="wsb-canvas-page page"
    ...
    <div id="wsb-canvas-template-container" style="position: absolute;">
        ...
        <div id="wsb-element-42da1001-2f7e-4c9a-ae6f-23013dfa5ad3" class="wsb-element-text" data-type="element">
            <div class="txt "><h2 style="text-align: center;"><span style="font-size:28px;">Contáctanos</span>
                </h2></div>
        </div>
        <div id="wsb-element-00000000-0000-0000-0000-000705083069" class="wsb-element-text" data-type="element">
        ...
        <div id="wsb-element-00000000-0000-0000-0000-000705083068" class="wsb-element-map" data-type="element">
            <div>
                <div class="map">
        ...
        <div id="wsb-element-00000000-0000-0000-0000-000705083064" class="wsb-element-customform"
            ...
            <div class="form customform form-row allow-select"
                 data-aid="elm-container-00000000-0000-0000-0000-000705083064">
                <div><input type="button" value="Enviar" data-groupid="20-desktop"
                            data-aid="submit-00000000-0000-0000-0000-000705083064-desktop" class="form-submit"
                            data-content=""></div>
                <div id="formMsgBox-desktop-00000000-0000-0000-0000-000705083064" class="form-message"
                     style="display: none;"> &#161;Muchas gracias por contactarnos! En breve nos comunicamos
                </div>

            </div>
        </div>
        <div id="wsb-element-00000000-0000-0000-0000-000705083063" class="wsb-element-customform"
             data-type="element">
            <div class="form customform form-row allow-select"
                 data-aid="elm-container-00000000-0000-0000-0000-000705083063">
                <div data-label-container-groupid="20-desktop"><label class="form-label"
                                                                      for="elm-00000000-0000-0000-0000-000705083063">
                        Mensaje: <span class="form-req">*</span></label></div>
                <div data-field-container-groupid="20-desktop"><textarea data-groupid="20-desktop"
                                                                         id="elm-00000000-0000-0000-0000-000705083063"
                                                                         class="form-value"
                                                                         data-label="Mensaje:"
        ...
        <div id="wsb-element-00000000-0000-0000-0000-000705083062" class="wsb-element-customform"
             data-type="element">
            <div class="form customform form-row allow-select"
                 data-aid="elm-container-00000000-0000-0000-0000-000705083062">
                <div data-label-container-groupid="20-desktop"><label class="form-label"
                                                                      for="elm-00000000-0000-0000-0000-000705083062">
                        Tel&#233;fono: <span class="form-req">*</span></label></div>
                <div data-field-container-groupid="20-desktop"><input type="text"
                                                                      id="elm-00000000-0000-0000-0000-000705083062"
                                                                      data-groupid="20-desktop"
                                                                      name="elm-00000000-0000-0000-0000-000705083062"
                                                                      data-label="Tel&#233;fono:"
                                                                      data-formtype="input" class="form-value"
                                                                      data-content="" required="true"></div>
            </div>
        </div>
        <div id="wsb-element-00000000-0000-0000-0000-000705083061" class="wsb-element-customform"
             data-type="element">
            <div class="form customform form-row allow-select"
                 data-aid="elm-container-00000000-0000-0000-0000-000705083061">
                <div data-label-container-groupid="20-desktop"><label class="form-label"
                                                                      for="elm-00000000-0000-0000-0000-000705083061">
                        Correo electr&#243;nico: <span class="form-req">*</span></label></div>
                <div data-field-container-groupid="20-desktop"><input type="email"
                                                                      id="elm-00000000-0000-0000-0000-000705083061"
                                                                      data-groupid="20-desktop"
                                                                      name="elm-00000000-0000-0000-0000-000705083061"
        ...
        <div id="wsb-element-00000000-0000-0000-0000-000705083060" class="wsb-element-customform"
             data-type="element">
            <div class="form customform form-row allow-select"
                 data-aid="elm-container-00000000-0000-0000-0000-000705083060">
                <div data-label-container-groupid="20-desktop"><label class="form-label"
                                                                      for="elm-00000000-0000-0000-0000-000705083060">
                        Nombre: <span class="form-req">*</span></label></div>
                <div data-field-container-groupid="20-desktop"><input type="text"
                                                                      id="elm-00000000-0000-0000-0000-000705083060"
                                                                      data-groupid="20-desktop"
                                                                      name="elm-00000000-0000-0000-0000-000705083060"
        ...
        <div id="wsb-element-00000000-0000-0000-0000-000588809925" class="wsb-element-text" data-type="element">
            <div class="txt "><p style="text-align: center;"><span
                            style="font-family:love ya like a sister;"><span style="font-size:36px;"><span
                                    style="color:#FFFFFF;">Un equipo creativo, conformado por&nbsp;profesionales de la&nbsp;cinematografía y fotografía de bodas.</span></span></span>
                </p></div>
        </div>
        ...
        <div id="wsb-element-00000000-0000-0000-0000-000588826509" class="wsb-element-image"
             data-type="element">
            <div class="wsb-image-inner ">
        ...
        <div id="wsb-element-00000000-0000-0000-0000-000588823433" class="wsb-element-text" data-type="element">
            <div class="txt ">
                <div><p><span class="editor_about">* Los sentimientos que envuelven cada momento, mueven cada etapa de nuestro trabajo<br></span>
                    </p>
                    <p><span class="editor_about"></span><span class="editor_about"></span><span
                                class="editor_about"><br></span></p>
                    <p><span class="editor_about">* Todos nuestros proyectos son hechos&nbsp;especialmente&nbsp;para&nbsp;ustedes, con su sello de pareja, logrando plasmar realmente su historia, no&nbsp;encontrarán&nbsp;algo&nbsp;igual.<br></span>
                    </p>
                    <p><span class="editor_about"></span><span class="editor_about"></span><span
                                class="editor_about"><br></span></p>
                    <p><span class="editor_about">* 100% creativo y nada cursi. Tendrán un video &nbsp;que&nbsp;todos querrán ver una y otra vez.</span><span
                                class="editor_about"></span></p></div>
            </div>
        </div>
        <div id="wsb-element-00000000-0000-0000-0000-000588756529" class="wsb-element-shape"
             data-type="element">
        ...
        <div id="wsb-element-00000000-0000-0000-0000-000588756519" class="wsb-element-text" data-type="element">
            <div class="txt "><h2 style="text-align: center;"><span
                            style="font-size:36px;">¿Por qué elegirnos?</span></h2></div>
        </div>
        ...
        <div id="wsb-element-8d8e1eca-6423-4f46-beeb-5980287a772e" class="wsb-element-image"
             data-type="element">
            <div class="wsb-image-inner ">
                <div class="img"><img
        ...
        <div id="wsb-element-00000000-0000-0000-0000-000588756515" class="wsb-element-image"
             data-type="element">
            <div class="wsb-image-inner ">
                <div class="img_main"><img
                            src="<?php echo IMAGES; ?>just_married.jpg"
